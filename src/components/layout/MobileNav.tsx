        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="fixed left-0 top-0 bottom-0 z-[99999] w-72 border-r border-border shadow-2xl md:hidden !bg-[#0a0a0a]"
              style={{ backgroundColor: '#0a0a0a' }}
            >
              {/* Solid background layer - fallback absoluto */}
              <div className="absolute inset-0 bg-[#0a0a0a]" aria-hidden="true" />
              
              {/* Content wrapper - acima do fundo */}
